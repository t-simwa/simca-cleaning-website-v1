...
const landscapingService: ServiceDetail = {
    ...
    steps: [
      {
        ...
        description: "We evaluate your outdoor space to understand soil conditions, sunlight exposure, and your vision for the landscape."
      },
      {
        title: "Design & Planning",
        description: "A customized landscaping plan is developed based on your preferences, budget, and site conditions."
      },
      {
        title: "Installation",
        description: "Professional installation of plants, irrigation systems, and landscape features according to the design plan."
      },
      {
        title: "Maintenance & Care",
        description: "Ongoing maintenance services to keep your landscape healthy, beautiful, and thriving throughout the seasons."
      }
    ]
  },
  pricing: {
    ...
    packages: [
      ...
      },
      {
        ...
        price: "Custom Quote",
        features: [
          "Medium residential/commercial spaces",
          "Garden design and installation",
          "Irrigation system",
  ...
  whyChooseUs: {
    ...
    description: "We specialize in creating and maintaining beautiful outdoor spaces that enhance your property value and quality of life.",
    points: [
  ...
  whatsIncluded: {
    ...
    description: "Our landscaping service covers all aspects to create and maintain beautiful outdoor spaces.",
    items: [
      ...
      "Seasonal updates and replanting"
    ]
  }
};
        ...
        <div className="container mx-auto px-4 relative">
          <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-8">
            ...
            <div className="w-full md:w-1/2 max-w-3xl md:pl-2 flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <p className="text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300 tracking-wide mb-5">
                If you're looking for a reliable landscaping service in Kenya, Simca Agencies is your trusted choice. We offer comprehensive landscaping services and always look for new ways to improve your outdoor space. Our team is flexible, creative, and ready to accommodate your specific landscaping needs—including special requests for custom designs and unique features.
              </p>
              <ul className="list-disc pl-5 space-y-4 text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300">
                <li>
                  <span className="font-semibold text-gray-800 dark:text-white">Garden design and installation</span> – Professional garden design and installation services including plant selection, layout planning, and installation of flower beds, shrubs, and trees. Our team creates beautiful, functional gardens that thrive in Kenya's climate and enhance your property's beauty.
                </li>
                <li>
                  <span className="font-semibold text-gray-800 dark:text-white">Lawn care and maintenance</span> – Comprehensive lawn installation, seeding, fertilizing, mowing, and maintenance services. We ensure your lawn remains healthy, green, and well-maintained throughout the seasons, providing a beautiful foundation for your landscape.
                </li>
                <li>
                  <span className="font-semibold text-gray-800 dark:text-white">Irrigation systems</span> – Professional installation and maintenance of efficient irrigation systems to ensure your landscape receives proper watering. Our systems are designed to conserve water while keeping your plants healthy and thriving.
                </li>
                <li>
                  <span className="font-semibold text-gray-800 dark:text-white">Seasonal care and maintenance</span> – Regular maintenance programs including mulching, weed control, pruning, seasonal planting, and landscape updates. We provide ongoing care to keep your landscape beautiful and healthy year-round.
                </li>
              </ul>
      </div>
          </div>
                  ...
                  >
                    ...
                    <div className="text-xs md:text-sm text-add8e6 font-bold mb-3">
                      ...
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        ...
                        <span>Small residential gardens</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaLeaf className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Basic lawn installation</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaLeaf className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
              ...
              <motion.div
                  ...
                  <div className="flex flex-col h-full relative z-10">
                    ...
                    <ul className="space-y-1.5 flex-grow mb-4">
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaLeaf className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Medium residential/commercial spaces</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaLeaf className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Garden design and installation</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaLeaf className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                ...
                >
                  <div className="flex flex-col h-full relative z-10">
                    ...
                    <ul className="space-y-1.5 flex-grow mb-4">
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaLeaf className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Large-scale landscape projects</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaLeaf className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Custom design and features</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaLeaf className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
