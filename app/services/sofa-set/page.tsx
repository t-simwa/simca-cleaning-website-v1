...
import { Sofa, ArrowRight, MapPin, Phone, Mail, Users, Calendar, ChevronLeft, ChevronRight, MessageCircle } from "lucide-react";
import { FaCouch } from "react-icons/fa"; // Font Awesome - Couch/Sofa (same as contact form)
                  ...
                  >
                    ...
                    <div className="text-xs md:text-sm text-add8e6 font-bold mb-3">
                      ...
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        ...
                        <span>Deep cleaning of single seater</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaCouch className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Fabric inspection and testing</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaCouch className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Stain removal and odor treatment</span>
                      </li>
                      </ul>
                      <Link
                        href="/contact"
              ...
              <motion.div
                  ...
                  <div className="flex flex-col h-full relative z-10">
                    ...
                    <ul className="space-y-1.5 flex-grow mb-4">
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaCouch className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Deep cleaning of two seater</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaCouch className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Fabric inspection and testing</span>
                ...
                >
                  <div className="flex flex-col h-full relative z-10">
                    ...
                    <ul className="space-y-1.5 flex-grow mb-4">
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaCouch className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Deep cleaning of three seater</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaCouch className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Fabric inspection and testing</span>
              ...
              <div className="flex justify-center mt-6">
                  ...
                  <div className="flex flex-col h-full relative z-10">
                    ...
                    <ul className="space-y-1.5 flex-grow mb-4">
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaCouch className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>L-shaped, sectional, or custom furniture</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaCouch className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Custom cleaning plans for unique furniture</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaCouch className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
