...
import { Wrench, ArrowRight, MapPin, Phone, Mail, Users, Calendar, ChevronLeft, ChevronRight, MessageCircle } from "lucide-react";
import { FaHardHat } from "react-icons/fa"; // Font Awesome - Hard Hat (same as contact form)
                  ...
                  >
                    ...
                    <div className="text-xs md:text-sm text-add8e6 font-bold mb-3">
                      ...
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaHardHat className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Homes and small renovations</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaHardHat className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Debris removal and surface cleaning</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaHardHat className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Interior dusting & cleaning</span>
                      </li>
                      </ul>
                      <Link
                        href="/contact"
              ...
              <motion.div
                  ...
                  <div className="flex flex-col h-full relative z-10">
                    ...
                    <ul className="space-y-1.5 flex-grow mb-4">
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaHardHat className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Offices, retail, industrial spaces</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaHardHat className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Large-scale debris removal</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaHardHat className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>High-reach dusting and floor care</span>
                      </li>
                    </ul>
                    <Link
                      href="/contact"
                ...
                >
                  <div className="flex flex-col h-full relative z-10">
                    ...
                    <ul className="space-y-1.5 flex-grow mb-4">
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaHardHat className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Enhanced fine dusting and detailing</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaHardHat className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Appliance and cabinetry cleaning</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaHardHat className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Vent and fixture cleaning</span>
                      </li>
                    </ul>
                    <Link
                      href="/contact"
              ...
              <div className="flex justify-center mt-6">
                  ...
                  <div className="flex flex-col h-full relative z-10">
                    ...
                    <ul className="space-y-1.5 flex-grow mb-4">
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaHardHat className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Large-scale construction projects</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaHardHat className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
                        <span>Specialized cleaning requirements</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                        <FaHardHat className="w-3.5 h-3.5 text-add8e6 mt-0.5 flex-shrink-0" />
