...
// Placeholder data for Window Cleaning Services
const windowService: ServiceDetail = {
  title: "Window Cleaning",
  description: "Achieve crystal clear views with our professional window cleaning services. We clean windows for residential and commercial buildings, ensuring a streak-free shine.",
  icon: <SquareStack className="h-8 w-8 md:h-10 md:w-10 text-add8e6" />,
  features: [
    "Streak-free window cleaning",
    "Interior and exterior window cleaning",
    "Cleaning of frames and sills",
    "Suitable for various building types",
    "Uses professional cleaning tools and solutions",
    "Removes dirt, grime, and water spots",
    "Improves natural light",
    "Experienced and safety-trained cleaners"
  ],
  ...
  process: {
    ...
    steps: [
      {
        title: "Assessment",
        description: "We assess the type and condition of windows and determine the best cleaning method."
      },
      {
        title: "Preparation",
        description: "Area around windows is prepared to protect surroundings."
      },
      {
        title: "Cleaning",
        description: "Windows, frames, and sills are cleaned using professional techniques."
      },
      {
        title: "Detailing",
        description: "Edges are wiped clean, ensuring a streak-free finish."
      }
    ]
  },
  pricing: {
    title: "Window Cleaning Pricing",
    packages: [
      {
        name: "Residential Windows",
        price: "Custom Quote",
        features: [
          "Pricing based on number and size of windows",
      ...
      },
      {
        ...
        price: "Custom Quote",
        features: [
          "Pricing based on building size and accessibility",
  ...
  whyChooseUs: {
    title: "Why Choose Us for Window Cleaning",
    description: "We deliver spotless windows that enhance the appearance of your property and let in more natural light.",
    points: [
      "Crystal clear, streak-free results",
      "Experienced and reliable cleaners",
  ...
  whatsIncluded: {
    ...
    description: "Our window cleaning service provides a comprehensive clean for your windows.",
    items: [
      "Cleaning of window glass (interior/exterior)",
...
export default function WindowCleaningPage() {
  ...
  const heroImage = {
    src: "/window/hero.webp",
    alt: "Professional window cleaning services in Kenya",
  }

  const whyChooseUsImage = {
    src: "/window/why-choose-us.webp",
    alt: "Professional window cleaning team at work",
  }

    const whatsIncludedImages = [
    {
      src: "/window/window-01.webp",
      alt: "Professional window cleaning services - exterior windows"
    },
    {
      src: "/window/window-02.webp",
      alt: "Window cleaning - interior windows"
    },
    {
      src: "/window/window-03.webp",
      alt: "Window cleaning - commercial buildings"
    },
    {
      src: "/window/window-04.webp",
      alt: "Window cleaning final inspection and quality check"
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <ServiceSchema {...serviceConfigs.windowCleaning} />
      <BreadcrumbSchema items={breadcrumbConfigs.windowCleaning} />
        ...
        <div className="container mx-auto px-8 sm:px-12 md:px-16 lg:px-20 xl:px-24 py-12 sm:py-16 md:py-20 lg:py-24 relative flex-grow flex flex-col justify-center">
          <div className="flex flex-col items-center">
            ...
            >
              ...
              >
                Achieve crystal clear views with our professional window cleaning services. We clean windows for residential and commercial buildings, ensuring a streak-free shine that enhances your property's appearance and lets in more natural light.
              </motion.p>
      ...
      <section className="relative py-12 md:py-16 lg:py-20">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-20">
            ...
            <div className="w-full md:w-1/2 max-w-3xl md:pl-14 flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <p className="text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300 tracking-wide mb-5">
                In the bustling city of Nairobi, maintaining crystal-clear windows can be a challenging task due to dust, pollution, and busy schedules. Professional window cleaning requires specialized skills, proper equipment, and attention to detail that goes beyond simple DIY methods. <span className="font-semibold text-gray-800 dark:text-white"><Link href="/" className="text-add8e6 hover:text-add8e6/80 transition-colors duration-300">Simca Agencies</Link></span> offers expert window cleaning solutions designed to deliver streak-free results and enhance your property's appearance, giving you more time to focus on what matters most.
              </p>
              <p className="text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300 tracking-wide mb-5">
                Among professional window cleaning services in Nairobi, <span className="font-semibold text-gray-800 dark:text-white"><Link href="/" className="text-add8e6 hover:text-add8e6/80 transition-colors duration-300">Simca Agencies</Link></span> is recognized for our commitment to quality, safety, and customer satisfaction. We are pleased to offer top-notch window cleaning services in Nairobi, Kenya, using professional tools and eco-friendly solutions. Our team is dedicated to consistently providing crystal-clear windows that improve natural light and enhance your property's curb appeal.
              </p>
              <p className="text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300 tracking-wide mb-5">
                Our comprehensive window cleaning services in Nairobi are tailored to address the unique challenges of maintaining clean windows in urban environments. We pay close attention to every detail, offering both interior and exterior cleaning, frame and sill maintenance, and flexible scheduling to suit your needs. With Simca, you can trust that every window will be cared for by trained professionals who prioritize safety and deliver exceptional results.
              </p>
                </div>
          ...
          </div> {/* End flex container for two columns */}
        </div> {/* End container mx-auto px-4 relative */}
      </section>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-8">
            ...
            <div className="w-full md:w-1/2 max-w-3xl md:pl-2 flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <p className="text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300 tracking-wide mb-5">
                If you're looking for a reliable window cleaning service in Nairobi, Simca Agencies is your trusted choice. We offer comprehensive window cleaning services and always look for new ways to improve your experience. Our team is flexible, thorough, and ready to accommodate your specific needs—including special requests for additional services.
              </p>
              <ul className="list-disc pl-5 space-y-4 text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300">
                <li>
                  <span className="font-semibold text-gray-800 dark:text-white">Interior window cleaning</span> – Professional cleaning of all interior window surfaces, including glass, frames, and sills. We remove dust, fingerprints, and smudges to ensure crystal-clear views from inside your property.
                </li>
                <li>
                  <span className="font-semibold text-gray-800 dark:text-white">Exterior window cleaning</span> – Thorough cleaning of exterior window surfaces, removing dirt, grime, water spots, and environmental pollutants. Our team uses professional equipment to reach all areas safely and effectively.
                </li>
                <li>
                  <span className="font-semibold text-gray-800 dark:text-white">Frame and sill cleaning</span> – Detailed cleaning of window frames, tracks, and sills to remove accumulated dirt and debris. We ensure all components are properly cleaned and maintained for optimal window performance.
                </li>
                <li>
                  <span className="font-semibold text-gray-800 dark:text-white">Screen cleaning</span> – Professional cleaning of window screens to remove dust, pollen, and other particles that can affect air quality and visibility. We handle both removable and fixed screens with care.
                </li>
              </ul>
      </div>
          </div>
          ...
          <ScrollAnimation>
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-8 md:mb-16">
                ...
                >
                  <strong>Note:</strong> The window cleaning service prices below are approximate and may vary based on the number and size of windows, your specific requirements, your location in Nairobi, and the cleaning package you choose. For unique properties or special requests, please contact us for a custom quote. All prices are per session and apply to Nairobi.
                </motion.p>
              </div>
              ...
              <div className="max-w-3xl mx-auto mt-8 text-center">
                <p className="text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300">
                  When comparing window cleaning service prices in Nairobi, consider factors such as reputation, reliability, and the range of services offered in addition to cost. Choosing a reputable cleaning company ensures your windows remain clean, clear, and enhance your property's appearance. For a personalized quote or to discuss your specific needs, please <Link href="/contact" className="text-add8e6 hover:underline">contact us</Link>.
                </p>
              </div>
            </div>
          </ScrollAnimation>
      ...
      <section className="relative py-12 md:py-20">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
            ...
            <p className="text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300">
              Have questions about our window cleaning services? Get a free window cleaning quote today! We're here to help.
            </p>
              </div>
