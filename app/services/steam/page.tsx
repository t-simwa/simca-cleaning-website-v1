...
import { Droplets, CheckCircle2, ArrowRight, MapPin, Phone, Mail, Clock, Sparkles, Shield, Users, Calendar, Star, Leaf, ChevronLeft, ChevronRight, Award, Settings, Wallet, MessageCircle } from "lucide-react";
...
// Placeholder data for Steam Cleaning
const steamService: ServiceDetail = {
  title: "Steam Cleaning",
  description: "Experience the power of steam for a deep and chemical-free clean. Our steam cleaning services are ideal for sanitizing and refreshing various surfaces.",
  icon: <Droplets className="h-8 w-8 md:h-10 md:w-10 text-add8e6" />,
  features: [
    "Chemical-free cleaning and sanitization",
    "Effective against germs, bacteria, and viruses",
    "Removes stubborn dirt and grime",
    "Ideal for various surfaces (tiles, grout, upholstery)",
  ...
  process: {
    title: "Our Steam Cleaning Process",
    steps: [
      {
        title: "Surface Assessment",
        description: "We identify the surface type and condition to ensure suitability for steam cleaning."
      },
      {
        title: "Pre-cleaning",
        description: "Loose dirt and debris are removed from the surface."
      },
      {
        title: "Steam Application",
        description: "High-temperature steam is applied to clean and sanitize."
      },
      {
        title: "Wiping and Drying",
        description: "Surfaces are wiped clean, and quick drying is ensured."
      }
    ]
  },
  pricing: {
    title: "Steam Cleaning Pricing",
    packages: [
      {
        name: "Basic Surface Clean",
        price: "From KES 2,000",
        features: [
          "Steam cleaning of tiled areas or countertops",
      ...
      },
      {
        ...
        features: [
          "Steam cleaning of a sofa or chairs",
          "Removes odors and sanitizes"
        ]
      },
      {
        name: "Full Room Sanitization",
        price: "Custom Quote",
        features: [
          "Comprehensive steam cleaning of a room",
          "Includes multiple surfaces",
  ...
  whyChooseUs: {
    title: "Why Choose Us for Steam Cleaning",
    description: "Our steam cleaning provides a powerful, eco-friendly, and chemical-free way to clean and sanitize your space.",
    points: [
      "Deep cleaning and sanitization",
      "Removes germs and allergens",
  ...
  whatsIncluded: {
    title: "What Our Steam Cleaning Includes",
    description: "Our steam cleaning service focuses on using high-temperature steam for effective cleaning and sanitization.",
    items: [
      "Surface preparation",
      "Application of high-temperature steam",
      "Wiping and drying of surfaces",
      "Focus on sanitization",
      "Suitable for hard surfaces and some upholstery"
    ]
  }
};
...
export default function SteamCleaningPage() {
  ...
  const heroImage = {
    ...
    alt: "Professional steam cleaning services in Kenya",
  }

  const steamCleaningImages = [
    {
      src: "/images/services/steam-cleaning-1.jpg",
      alt: "Professional steam cleaning services - kitchen"
    },
    {
      src: "/images/services/steam-cleaning-2.jpg",
      alt: "Steam cleaning - bathroom tiles"
    },
    {
      src: "/images/services/steam-cleaning-3.jpg",
      alt: "Steam cleaning - upholstery"
    },
    {
      src: "/images/services/steam-cleaning-4.jpg",
      alt: "Steam cleaning - floor grout"
    }
  ];
  const [carouselIndex, setCarouselIndex] = useState(0);
  const nextImage = () => setCarouselIndex((prev) => (prev + 1) % steamCleaningImages.length);
  const prevImage = () => setCarouselIndex((prev) => (prev - 1 + steamCleaningImages.length) % steamCleaningImages.length);
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-8 sm:px-12 md:px-16 lg:px-20 xl:px-24 py-12 sm:py-16 md:py-20 lg:py-24 relative flex-grow flex flex-col justify-center">
          <div className="flex flex-col items-center">
            ...
            >
              ...
              >
                Experience the power of steam for a deep and chemical-free clean. Our steam cleaning services use high-temperature steam to sanitize and refresh various surfaces, eliminating germs, bacteria, and stubborn dirt without harsh chemicals. Perfect for homes with children, pets, or anyone seeking an eco-friendly cleaning solution.
              </motion.p>
      ...
      {/* Why Choose Our Steam Cleaning Services Section */}
          ...
          <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-20">
            ...
            <div className="w-full md:w-1/2 max-w-3xl md:pl-14 flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <div className="w-full mb-6 md:hidden">
                <div className="rounded-xl overflow-hidden shadow-lg w-full max-w-2xl h-[20rem] xs:h-[24rem] sm:h-[28rem] mx-auto">
                  <Image
                    src="/images/services/steam-cleaning-1.jpg"
                    alt="Professional steam cleaning services"
                    width={800}
                    height={600}
              ...
              <p className="text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300 tracking-wide mb-5">
                In today's health-conscious world, maintaining a truly clean and sanitized environment has become more important than ever. <span className="font-semibold text-gray-800 dark:text-white"><Link href="/" className="text-add8e6 hover:text-add8e6/80 transition-colors duration-300">Simca Agencies</Link></span> offers advanced steam cleaning services that go beyond traditional cleaning methods, using high-temperature steam to eliminate germs, bacteria, and stubborn dirt without harsh chemicals. Our steam cleaning solutions provide a powerful, eco-friendly approach to deep cleaning and sanitization.
              </p>
              <p className="text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300 tracking-wide mb-5">
                <span className="font-semibold text-gray-800 dark:text-white"><Link href="/" className="text-add8e6 hover:text-add8e6/80 transition-colors duration-300">Simca Agencies</Link></span> stands out as a leader in steam cleaning services in Kenya, combining cutting-edge technology with proven cleaning techniques. Our steam cleaning process uses temperatures that effectively kill 99.9% of germs and bacteria, making it ideal for homes with children, pets, or anyone seeking a chemical-free cleaning solution. We're committed to delivering exceptional results that promote health and well-being.
              </p>
              <p className="text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300 tracking-wide mb-5">
                Our comprehensive steam cleaning services are designed to tackle the toughest cleaning challenges while being gentle on your surfaces. From kitchen countertops and bathroom tiles to upholstery and grout lines, our steam cleaning technology penetrates deep into surfaces to remove dirt, grease, and allergens that traditional cleaning methods often miss. With Simca, you can trust that every surface will be thoroughly cleaned and sanitized using the power of steam.
              </p>
            </div>
            ...
            <div className="w-full md:w-1/2 flex justify-center md:pr-8 mb-8 md:mb-0 hidden md:flex">
              <div className="relative rounded-xl overflow-hidden shadow-lg w-full max-w-2xl h-[47rem] mx-auto">
                <Image
                  src={steamCleaningImages[carouselIndex].src}
                  alt={steamCleaningImages[carouselIndex].alt}
                  width={800}
                  height={600}
                  className="object-cover w-full h-full"
                />
          ...
          >
            ...
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-white mb-6 md:mb-6 leading-tight tracking-wide">
              ...
              <span className="inline-block block mb-1 ml-2">
                <span className="text-add8e6 relative inline-block">Steam
                  <motion.span
                    className="absolute -bottom-1 md:-bottom-2 left-0 w-full h-0.5 md:h-1 bg-add8e6/20 rounded-full origin-left block"
                    initial={{ scaleX: 0 }}
                    whileInView={{ scaleX: 1 }}
            ...
            <p className="text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300 tracking-wide">
              Experience the difference that professional steam cleaning can make in your daily life. From deep sanitization to eco-friendly cleaning, discover why homeowners choose our steam cleaning services.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                content: (
                  <>
                    One of the most significant advantages of choosing <span className="font-semibold text-gray-800 dark:text-white"><Link href="/" className="text-add8e6 hover:text-add8e6/80 transition-colors duration-300">Simca Agencies</Link></span> for steam cleaning is the time-saving convenience it offers. Our high-temperature steam cleaning process is incredibly efficient, penetrating deep into surfaces to remove dirt, grease, and bacteria in a fraction of the time traditional cleaning methods require. Whether it's a one-time deep sanitization or regular maintenance, our skilled team will efficiently tackle the task, allowing you to focus on what matters most.
                  </>
                )
              },
              {
                ...
                content: (
                  <>
                    <span className="font-semibold text-gray-800 dark:text-white"><Link href="/" className="text-add8e6 hover:text-add8e6/80 transition-colors duration-300">Simca Agencies</Link></span> prides itself on delivering exceptional quality steam cleaning services in Kenya that surpasses expectations. Equipped with advanced steam cleaning technology and proven techniques, our trained professionals ensure a thorough and effective clean every time. From kitchen countertops to bathroom tiles and upholstery, we guarantee a spotless, sanitized environment that promotes health and well-being.
                  </>
                )
              },
              {
                ...
                content: (
                  <>
                    A steam-cleaned environment is crucial for maintaining good health, and <span className="font-semibold text-gray-800 dark:text-white"><Link href="/" className="text-add8e6 hover:text-add8e6/80 transition-colors duration-300">Simca Agencies</Link></span> understands this well. Our steam cleaning process eliminates 99.9% of germs, bacteria, and allergens without harsh chemicals, creating healthier living spaces for you and your family. This is particularly beneficial for individuals with allergies or respiratory conditions, as well as families aiming to provide a safe and hygienic environment for their children and pets.
                  </>
                )
              },
              {
                ...
                content: (
                  <>
                    <span className="font-semibold text-gray-800 dark:text-white"><Link href="/" className="text-add8e6 hover:text-add8e6/80 transition-colors duration-300">Simca Agencies</Link></span> offers flexible and customized steam cleaning solutions tailored to your specific needs. Whether you require comprehensive surface sanitization, specialized services like grout cleaning or upholstery refresh, or regular maintenance steam cleaning, we can accommodate your requirements. Our personalized approach ensures that every surface receives the attention it deserves with the power of steam.
                  </>
                )
              },
              {
                ...
                content: (
                  <>
                    With <span className="font-semibold text-gray-800 dark:text-white"><Link href="/" className="text-add8e6 hover:text-add8e6/80 transition-colors duration-300">Simca Agencies</Link></span>, you can expect consistency and reliability in every steam cleaning session. Our dedicated team follows a strict steam cleaning regimen and schedule, ensuring that your space remains consistently clean, sanitized, and well-maintained. Whether it's a residential home, apartment, or commercial space, you can trust us to deliver impeccable steam cleaning results time and time again.
                  </>
                )
              },
              {
                ...
                content: (
                  <>
                    <span className="font-semibold text-gray-800 dark:text-white"><Link href="/" className="text-add8e6 hover:text-add8e6/80 transition-colors duration-300">Simca Agencies</Link></span> is staffed by trained professionals who possess the expertise and skills needed to handle various steam cleaning challenges. Our attention to detail, professionalism, and commitment to customer satisfaction set us apart in the industry. Whether it's tackling tough stains, sanitizing surfaces, or restoring the luster of your tiles and grout, our steam cleaning team is up to the task.
                  </>
                )
              },
              {
                ...
                content: (
                  <>
                    While some may perceive professional steam cleaning services as a luxury, <span className="font-semibold text-gray-800 dark:text-white"><Link href="/" className="text-add8e6 hover:text-add8e6/80 transition-colors duration-300">Simca Agencies</Link></span> offers cost-effective solutions that provide excellent value for money. When you consider the time saved, the superior sanitization results, the elimination of chemical costs, and the benefits of a truly clean environment, investing in our steam cleaning services becomes a wise decision for your cleaning needs in Kenya.
                  </>
                )
              }
            ].map((para, i) => (
      ...
      {/* What's Included in Our Steam Cleaning Services Section */}
      <section className="relative py-12 md:py-16 lg:py-20">
        {/* Animated gradient background */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-blue-900/20 dark:via-gray-900 dark:to-blue-800/20 animate-gradient">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(173,216,230,0.1),transparent_70%)] animate-pulse" />
        ...
        <div className="container mx-auto px-4 relative">
          <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-8">
            ...
            <div className="w-full md:w-1/2 flex justify-center md:pr-2 mb-8 md:mb-0 hidden md:flex">
              <div className="relative rounded-xl overflow-hidden shadow-lg w-full max-w-2xl h-[47rem] mx-auto">
                <AnimatePresence mode="wait">
                  <motion.div
                    key={steamCleaningImages[carouselIndex].src}
                ...
                <div className="hidden md:flex absolute bottom-6 left-1/2 -translate-x-1/2 gap-2 z-10">
                  {steamCleaningImages.map((img, idx) => (
                    <button
                      key={img.src}
            ...
            <div className="w-full md:w-1/2 max-w-3xl md:pl-2 flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <p className="text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300 tracking-wide mb-5">
                If you're looking for a reliable steam cleaning service in Nairobi, Simca Agencies is your trusted choice. We offer comprehensive steam cleaning solutions that go beyond traditional cleaning methods, using high-temperature steam to eliminate germs, bacteria, and stubborn dirt. Our team is flexible, thorough, and ready to accommodate your specific steam cleaning needs—including special requests for additional services.
              </p>
              <ul className="list-disc pl-5 space-y-4 text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300">
                <li>
                  <span className="font-semibold text-gray-800 dark:text-white">Kitchen surfaces</span> – Steam cleaning of countertops, appliances, tiles, and kitchen fixtures. Our high-temperature steam penetrates deep into surfaces to remove grease, food residue, and bacteria. We also steam clean inside appliances, microwave interiors, and kitchen cabinets for comprehensive sanitization.
                </li>
                <li>
                  <span className="font-semibold text-gray-800 dark:text-white">Bathroom sanitization</span> – Steam cleaning of tiles, grout lines, toilet seats, bathtubs, shower cubicles, and bathroom fixtures. Our steam process eliminates 99.9% of germs and bacteria while removing soap scum, mold, and mildew. We also steam clean bathroom floors and polish accessible surfaces.
                </li>
                <li>
                  <span className="font-semibold text-gray-800 dark:text-white">Floor and grout cleaning</span> – Steam cleaning of tiled floors, grout lines, baseboards, and hard surface flooring. Our steam technology penetrates deep into grout to remove dirt, stains, and bacteria that traditional cleaning methods often miss. We also steam clean stone surfaces and sealed concrete floors.
                </li>
                <li>
                  <span className="font-semibold text-gray-800 dark:text-white">Upholstery and fabric</span> – Steam cleaning of furniture, curtains, carpets, and fabric surfaces. Our steam process refreshes upholstery, removes odors, and sanitizes fabric without harsh chemicals. We also steam clean mattresses, pillows, and other fabric items for deep sanitization.
                </li>
              </ul>
            </div>
          </div>
          ...
          <ScrollAnimation>
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-8 md:mb-16">
                ...
                >
                  <strong>Note:</strong> The steam cleaning service prices below are approximate and may vary based on the size of the area, surface type, your specific requirements, your location in Nairobi, and the steam cleaning package you choose. For unique surfaces or special requests, please contact us for a custom quote. All prices are per session and apply to Nairobi.
                </motion.p>
              </div>
                ...
                >
                  ...
                  <div className="flex flex-col h-full relative z-10">
                    ...
                    <ul className="space-y-2 flex-grow mb-6">
                      <li className="flex items-center text-xs md:text-sm text-gray-600 dark:text-gray-300">
                        <CheckCircle2 className="w-4 h-4 text-add8e6 mr-2" />
                        Full home steam cleaning
                      </li>
                      <li className="flex items-center text-xs md:text-sm text-gray-600 dark:text-gray-300">
                        <CheckCircle2 className="w-4 h-4 text-add8e6 mr-2" />
                        Extensive surfaces and areas
                      </li>
                      <li className="flex items-center text-xs md:text-sm text-gray-600 dark:text-gray-300">
                        <CheckCircle2 className="w-4 h-4 text-add8e6 mr-2" />
                ...
                >
                  ...
                  <div className="flex flex-col h-full relative z-10">
                    ...
                    <ul className="space-y-2 flex-grow mb-6">
                      <li className="flex items-center text-xs md:text-sm text-gray-600 dark:text-gray-300">
                        <CheckCircle2 className="w-4 h-4 text-add8e6 mr-2" />
                        Custom steam cleaning for special surfaces
                      </li>
                      <li className="flex items-center text-xs md:text-sm text-gray-600 dark:text-gray-300">
                        <CheckCircle2 className="w-4 h-4 text-add8e6 mr-2" />
                        Industrial or commercial steam cleaning
                      </li>
                      <li className="flex items-center text-xs md:text-sm text-gray-600 dark:text-gray-300">
                        <CheckCircle2 className="w-4 h-4 text-add8e6 mr-2" />
              ...
              <div className="max-w-3xl mx-auto mt-8 text-center">
                <p className="text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300">
                  When comparing steam cleaning service prices in Nairobi, consider factors such as reputation, reliability, and the range of services offered in addition to cost. Choosing a reputable steam cleaning company ensures your surfaces remain clean, sanitized, and healthy for your family and guests. For a personalized quote or to discuss your specific steam cleaning needs, please <Link href="/contact" className="text-add8e6 hover:underline">contact us</Link>.
                </p>
              </div>
            </div>
          </ScrollAnimation>
      ...
      {/* Contact Section (with steam page background) */}
      <section className="relative py-12 md:py-16 lg:py-20">
        {/* Animated gradient background */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-blue-900/20 dark:via-gray-900 dark:to-blue-800/20 animate-gradient">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(173,216,230,0.1),transparent_70%)] animate-pulse" />
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
            ...
            <p className="text-sm md:text-base lg:text-base text-gray-600 dark:text-gray-300">
              Have questions about our steam cleaning services? Get a free steam cleaning service quote today! We're here to help.
            </p>
          </div>
