          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-6 md:p-8 rounded-xl shadow-sm max-w-2xl mx-auto">
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
                  ...
                  className="flex-1 px-4 py-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white/50 dark:bg-gray-900/50 focus:outline-none focus:ring-2 focus:ring-add8e6/50 text-gray-800 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                    required
                  />
                <button
                  type="submit"
            ...
            {isSuccess ? (
              <div className="mt-4 md:mt-6 p-3 md:p-4 rounded-lg md:rounded-xl text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/20">
                <h3 className="font-semibold text-green-800 dark:text-green-300">Thank you for subscribing!</h3>
            ...
            <p className="mt-4 md:mt-6 text-xs md:text-sm text-gray-500 dark:text-gray-400">
